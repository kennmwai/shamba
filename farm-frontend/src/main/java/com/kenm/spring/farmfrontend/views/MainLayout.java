package com.kenm.spring.farmfrontend.views;
...
import com.kenm.spring.farmfrontend.data.User;
import com.kenm.spring.farmfrontend.security.AuthenticatedUser;
import com.kenm.spring.farmfrontend.views.addressform.AddressFormView;
import com.kenm.spring.farmfrontend.views.checkoutform.CheckoutFormView;
import com.kenm.spring.farmfrontend.views.creditcardform.CreditCardFormView;
import com.kenm.spring.farmfrontend.views.home.HomeView;
import com.kenm.spring.farmfrontend.views.imagegallery.ImageGalleryView;
import com.kenm.spring.farmfrontend.views.masterdetail.MasterDetailView;
import com.kenm.spring.farmfrontend.views.personform.PersonFormView;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(HomeView.class)) {
            nav.addItem(new SideNavItem("Empty", HomeView.class, LineAwesomeIcon.FILE.create()));
