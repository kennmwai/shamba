...
public class FarmLeaseDTO implements Serializable {
	...
	public FarmLeaseDTO(Long id, String farmerName, String farmAddress, String crop, Integer acres,
			Double pricePerAcre) {
		super();
		this.id = id;
	...
	public String toString() {
		return "FarmLeaseDTO [id=" + id + ", farmerName=" + farmerName + ", farmAddress=" + farmAddress + ", crop="
